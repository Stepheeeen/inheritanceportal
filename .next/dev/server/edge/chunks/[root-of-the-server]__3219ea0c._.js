(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__3219ea0c._.js",
...
"[project]/app/api/cases/route.ts [app-edge-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (id) {
        const c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["getCaseById"])(id);
        if (!c) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Not found'
        }, {
            status: 404
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(c);
    }
    if (beneficiaryId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["cases"].filter((c)=>c.beneficiaryId === beneficiaryId));
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["cases"]);
}
async function POST(request) {
    const body = await request.json();
    const newItem = {
        ...body,
        id: body.id ?? `c-${Math.floor(Math.random() * 9000) + 1000}`,
        createdAt: new Date().toISOString(),
        status: body.status ?? 'open'
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["cases"].push(newItem);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3219ea0c._.js.map